...
class AuthControllerTest {
    ...
    internal inner class LoginTest {
        ...
        fun givenSuccessfulPath_whenLogin_thenReturn200() {
            ...
            Assertions.assertEquals(generatedToken, response.body!!.token)
            ...
            Assertions.assertEquals(UserController.URL + "/" + user.username, response.body!!.userResponse.resourceUrl)
        }
    }
